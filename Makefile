...
test_install_mac:
	...
	install_name_tool -change @rpath/QtWidgets.framework/Versions/5/QtQuick /Users/runner/work/FOEDAG_rs/Qt/5.15.2/clang_64/lib/QtQuick.framework/QtQuick $(PREFIX)/bin/raptor_gui
